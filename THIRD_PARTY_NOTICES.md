...
### GeoNet (New Zealand)
- Operator: GNS Science (GeoNet programme)
- Bucket: `s3://geonet-open-data` (ap-southeast-2)
- License: CC-BY-4.0
- Citation: cite GeoNet and the NZ network operators per GeoNet's data policy
- Reference: https://www.geonet.org.nz/data/supplementary/channels
