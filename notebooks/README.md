...
| [06_cross_correlation_three_archives.ipynb](06_cross_correlation_three_archives.ipynb) | NoisePy cross-correlations of three stations pulled from three archives (SCEDC, NCEDC, EarthScope S3), obspy-free preprocessing, month-long stack with surface-wave moveouts (~1.1 GB fetch + ~20 min compute on first run) | `matplotlib`, `noisepy-seis` |
