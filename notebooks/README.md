...
| [06_cross_correlation_three_archives.ipynb](06_cross_correlation_three_archives.ipynb) | NoisePy cross-correlations of three stations pulled from three archives (SCEDC, NCEDC, EarthScope S3), obspy-free preprocessing, 7-day stack with surface-wave moveouts | `matplotlib`, `noisepy-seis` |
